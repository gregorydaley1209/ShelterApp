            ...
            <div className="relative mx-auto max-w-7xl px-6 py-14 lg:px-8 lg:py-20">
              <div className="mx-auto max-w-3xl text-center">
                ...
                <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-600">
                  View volunteer check-ins, totals, and reports.
                </p>
              </div>
              ...
              <div className="mt-12 grid gap-8 md:grid-cols-2">
                <ActionCard
                  ...
                  desc="See volunteer names and total hours logged."
                  cta="Open view page"
                  onClick={() => router.push("/admin/volunteer/view")}
                  icon={<VolunteerListIcon />}
                />

                <ActionCard
                  title="Edit volunteers"
                  desc="Correct or manage volunteer naming for consistent reporting."
                  cta="Open edit page"
                  onClick={() => router.push("/admin/volunteer/edit")}
                  icon={<EditIcon />}
                />

                <ActionCard
                  title="Volunteer reports"
                  desc="View totals by volunteer and group across your selected range."
                  cta="Open reports"
                  onClick={() => router.push("/admin/volunteer/reports")}
                  icon={<ReportIcon />}
                />
              </div>
            </div>
